...
@given(
    "A project with a title {tit}, a description {desc}, an active status {act}, a completed status {comp} and an id {id}")
...
@step(
    'The user receives a default project back in the response with title = "", description = "", completed = False, active = False')
def step_impl(context):
